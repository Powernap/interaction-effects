...
'load_spine' <- function(only_subjects_with_image_data = FALSE) {
  ...
  'load_spine.helper.rename_dimensions' <- function(data) {
    dims <- c("Gender", "Age", "hard_working", "hard_working_years", 
      "Whole_body_vibration", "Whole_body_vibration_years",
      "Sport_Winter", "Sport_Summer", "posuture_work",
      "Gallbladder_stones", "thrombosis", "kidney_disease",
      "dialysis", "joint_degeneration", "spine_abrasion",
      "joint_disease", "osteoporosis", "liver_cirrhosis",
      "fatty_liver", "cholecystitis", "Increased_blood_lipid",
      "gout", "bronchitis", "diabetes", "diabetes_treatment",
      "already_pregnant", "number_of_children",
      "age_menstrual_period", "Hormone_replacement_therapy",
      "already_menstrual_period", "high_blood_pressure",
      "high_blood_pressure_medication", "pulmonary_disease",
      "thyroid_disease", "Hyperthyroidism", "Hypothyroidism",
      "thyroid_goiter", "thyroid_nodules", "pain_last_7_days",
      "back_pain_last_3_month", "back_pain_last_3_month_intensity",
      "early_retirement_reason", "income", "body_fat_percent",
      "size", "weight", "hip_size",
      "back_pain_induced_social_problems", "neck_shoulder_pain",
      "joint_limb_pain", "frequency_of_alcohol_last_year",
      "If_alcohol_how_much", "pancreatitis", "hepatitis",
      "nutrition_meat", "nutrition_sausage", "nutrition_fish",
      "nutrition_potatoes", "nutrition_French", "nutrition_pasta",
      "nutrition_rice", "nutrition_vegetables",
      "nutrition_Gemuese_gekocht", "nutrition_fruit",
      "nutrition_bread", "nutrition_Muesli", "nutrition_eggs",
      "nutrition_cake", "nutrition_confectionery_products",
      "nutrition_munchies", "heart_failure", "number_of_cigarettes",
      "age_started_smoking", "other_thyroid_disease",
      "marital_status", "living_with_partner", "HBA1C",
      "triglycerides", "cholesterol", "hdl_cholesterol",
      "ALAT_S", "ASAT_S", "AMYL_S", "GGT_S", "LIP_S", "hepatitis_B",
      "Hepatitis_C", "acne", "hypotension", "uropathy", "Parkinson",
      "other_diseases", "pain_legs", "pain_feet",
      "inactive_days_due_to_back_pain",
      "impairment_by_backpain_3_month", "radiating_backpain",
      "Globus", "short_winded", "weakness", "sip_complain",
      "pain_chest", "bloating", "languor", "nausea", "burping",
      "irritability", "brooding", "sweating", "internal_unrest",
      "heaviness", "restlessness_legs", "heat_hypersensitive",
      "cold_hypersensitive", "high_need_for_sleep", "insomnia",
      "vertigo", "tremor", "loss_in_weight", "headache",
      "tiredness", "difficulty_in_breathing", "suffocation",
      "palpitation", "anxiety", "abdominal_pain", "anergy",
      "attentiveness_disorder", "hot_flashes", "tension", "numbness",
      "meteorosensitivity", "hearing_problems", "depression",
      "Mean_Curvature", "Mean_Torsion", "Mean_Curvature_Coronal",
      "Mean_Curvature_Sagittal", "Mean_Curvature_Transverse",
      "Curvature_Angle", "Curvature_Angle_Sagittal",
      "Curvature_Angle_Coronal", "Curvature_Angle_Transverse", "BMI")
    colnames(data) <- dims
    return(data)
  }
